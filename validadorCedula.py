...
def cedulaEsValida(cedula):
    if len(cedula) != 10:
        return "No valida: debe de ser de 10 digitos"
    else:
        ...
        if int(cedula[2]) > 6:
            ...
            for index in range(0, 9):
                ...
                if producto >= 10:
                    ...
                    digitoValidador = int(math.ceil(sum(resultado) / 10.0)) * 10 - sum(resultado)
                    if digitoValidador != int(cedula[9]):
